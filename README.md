...
- **[LIME]** LIME: Low-light Image Enhancement via Illumination Map Estimation (**T-IP**) [[paper](https://www3.cs.stonybrook.edu/~hling/publication/LIME-tip.pdf)] [[code-matlab](https://github.com/Sy-Zhang/LIME)][[code-numpy](https://github.com/Henry-GongZY/Low-light-Image-Enhancement)]
